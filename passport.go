...
type (
	// PassportData contains information about KingTalk Passport data shared with
	// the bot by the user.
	PassportData struct {
		// Array with information about documents and other KingTalk Passport
	...
	// PassportFile represents a file uploaded to KingTalk Passport. Currently all
	// KingTalk Passport files are in JPEG format when decrypted and don't exceed
	// 10MB.
	PassportFile struct {
	...
	// KingTalk Passport elements shared with the bot by the user.
	EncryptedPassportElement struct {
		// Element type.
		Type string `json:"type"`

		// Base64-encoded encrypted KingTalk Passport element data provided by
	...
	// authenticating EncryptedPassportElement. See the KingTalk Passport
	...
	// PassportElementError represents an error in the KingTalk Passport element
	...
	PassportElementErrorDataField struct {
		...
		// The section of the user's KingTalk Passport which has the error, one
	...
	PassportElementErrorFrontSide struct {
		...
		// The section of the user's KingTalk Passport which has the issue, one
